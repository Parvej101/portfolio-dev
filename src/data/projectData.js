...
export const projects = [
  ...
  },
  {
    ...
    images: [
      { src: "/images/p1.jpg", alt: "Class Vault Screenshot 1" },
      { src: "/images/p2.jpg", alt: "Class Vault Screenshot 2" },
      { src: "/images/p3.jpg", alt: "Class Vault Screenshot 3" },
    ],
  ...
  {
    name: "Hope Hive",
    description: "A community-driven platform that connects individuals with resources, support, and services to promote well-being.",
    images: [
      { src: "/images/b1.jpg", alt: "Hope Hive Screenshot 1" },
      { src: "/images/b2.jpg", alt: "Hope Hive Screenshot 2" },
      { src: "/images/b3.jpg", alt: "Hope Hive Screenshot 3" },
    ],
